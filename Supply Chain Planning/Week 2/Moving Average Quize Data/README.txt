Moving Average Quiz Instructions
...
2. There are five products for which you have to create a forecast. Start by creating a moving average forecast (N=3). In addition, you must apply the calculations for mean error, mean absolute percent error, and mean squared error for each of the five products.
